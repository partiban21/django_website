...
//on submit click of form with id addComment, one add comment method for each article
$(document).on('submit', '#addComment', function(e){
    e.preventDefault();
    console.log('In the method')
    $.ajax({
      type: 'POST',
      url: '/addComment/',//method in view python called 
      dataType: 'html',
      headers:{
          'X-CSRFTOKEN': $("[name=csrfmiddlewaretoken]").val(),
      },
      data:{
        comment: $('#Article #comment').val(),//data variables passed to python
